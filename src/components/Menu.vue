...
<aside class="menu" :class="{ 'is-active': isActive }" @click="hideMenu">
  ...
  <ul class="menu-list has-text-centered">
    <li><router-link to="/"><svg class="feather"><use href="/img/feather-sprite.svg#play"></use></svg><div class="detail">Playing</div></router-link></li>
    <li><router-link to="/playlists"><svg class="feather"><use href="/img/feather-sprite.svg#list"></use></svg><div class="detail">Playlists</div></router-link></li>
    <li><router-link to="/artists"><svg class="feather"><use href="/img/feather-sprite.svg#mic"></use></svg><div class="detail">Artists</div></router-link></li>
    ...
    <li><router-link to="/logout"><svg class="feather"><use href="/img/feather-sprite.svg#log-out"></use></svg><div class="detail">Log Out</div></router-link></li>
  </ul>
</aside>
</template>
<script>
