...
if [[ "$init_type" != 'none' ]]; then
  ...
  mkdir -p '/home/{{ node_deb_user }}'
  chown -R '{{ node_deb_user }}:{{ node_deb_group }}' '/home/{{ node_deb_user }}'

  mkdir -p '/var/log/{{ node_deb_package_name }}'
  chown -R '{{ node_deb_user }}:{{ node_deb_group }}' '/var/log/{{ node_deb_package_name }}'

  mkdir -p '{{ node_deb_install_dir }}/{{ node_deb_package_name }}/app/data/art'
  touch '{{ node_deb_install_dir }}/{{ node_deb_package_name }}/app/data/falk.db'
  chown -R '{{ node_deb_user }}:{{ node_deb_group }}' '{{ node_deb_install_dir }}/{{ node_deb_package_name }}/app/data'
